    ...
    var Favorite = {
        ...
        "goOffline": function() {
            ...
            jNavItem.find("#sync").click( function() {
                ...
                var HttpAddress = Parse.Object.extend("HttpAddress");
                var fav = new HttpAddress();
                fav.set("favorite", json);
                fav.save(null, {
                    success: function(httpAddress){
                        alert("success");
                    }, 
                    error: function(httpAddress, error){
                        alert("fail");
                    }
                });
            });
